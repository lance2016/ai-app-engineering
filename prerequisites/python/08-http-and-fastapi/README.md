...
- [P06 Pydantic v2](../06-pydantic/README.md)：FastAPI 的请求体校验就是 Pydantic
- [P07 asyncio](../07-asyncio/README.md)：流式响应的例子用了 `async` 生成器
...
[← P07](../07-asyncio/README.md) · [P09 →](../09-sql-and-sqlalchemy/README.md)
