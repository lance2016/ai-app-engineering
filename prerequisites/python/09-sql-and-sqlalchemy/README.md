...
# P09 SQL、PostgreSQL 与 SQLAlchemy
...
- [P05 类型注解](../05-typing/README.md)：SQLAlchemy 2.0 的模型全靠 `Mapped[int]` 这种注解
...
[← P08](../08-http-and-fastapi/README.md) · [P10 →](../10-testing/README.md)
