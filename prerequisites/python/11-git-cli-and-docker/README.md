...
2. 装好 Docker Desktop（或 OrbStack），`docker compose -f prerequisites/python/11-git-cli-and-docker/code/compose.yaml up -d`，然后 `docker compose ... ps` 看两个服务是否 healthy，最后 `down -v` 清掉。
...
[← P10](../10-testing/README.md) · [→ 进入主线第 00 课](../../../lessons/00-setup/README.md)
