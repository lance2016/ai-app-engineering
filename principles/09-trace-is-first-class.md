...
- **异常被记录了，没人看见。** 语音机器人项目里踩过：`span.record_exception(e)` 写了，`set_status` 没写，Phoenix 里所有 span 都是绿色的，一批工具超时静默了两周。
...
`tracer` 可以是 OpenTelemetry SDK，也可以是第 20 课里五十行的自制版。属性名不变，后端随时换。
...
- 相关课程：[20 可观测性](../lessons/observability/README.md)
