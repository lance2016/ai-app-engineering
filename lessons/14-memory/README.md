...
![本课核心关系：记忆提取、巩固、召回与遗忘的生命周期](./images/14-memory-lifecycle.svg)
...
## 生产方案
M4 的 memory 模块把提取、整合、检索和删除分开，来源回指事件线程，删除动作写审计。

## 框架映射

| 本课概念 | LangGraph | OpenAI Agents SDK | Claude Agent SDK |
|---|---|---|---|
| memory extraction / consolidation | state + store + retriever | session / conversation history | session persistence + project memory |
