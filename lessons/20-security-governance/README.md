...
## 生产方案
M3/M5 的 allowlist、tenant binding、PII 过滤、Skill 哈希和工具确认组成确定性 guardrail；项目测试覆盖越权和注入反例。

## 框架映射

| 本课概念 | LangGraph | OpenAI Agents SDK | Claude Agent SDK |
|---|---|---|---|
| guardrails / allowlist / tenant policy | tool node guard + application middleware | tool approval + input/output guardrails | permission mode + can_use_tool callback |
