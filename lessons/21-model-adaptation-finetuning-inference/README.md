...
## 生产方案
M6 的 ADR 记录模型、RAG、微调和托管 / 自建推理的假设；M5 的 adapter 与成本账支持低风险切换。

## 框架映射

| 本课概念 | LangGraph | OpenAI Agents SDK | Claude Agent SDK |
|---|---|---|---|
| model routing / adapter / eval gate | model node + configurable provider | model settings + handoff | model / permission options |
