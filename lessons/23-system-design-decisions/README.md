...
改 `p95_turn_seconds` 看并发数怎么变，你会明白**第 19 课的延迟优化同时也是容量优化**：把 p95 从 8 秒降到 4 秒，需要的并发容量直接减半。
...
>
> **后果**
> - 需要带文档版本和删除的入库管线（第 15 课）
> - 上线前需要每租户 golden set 上的 Recall@k（第 17 课）
...
[← 上一课 22](../22-product-design-ux/README.md) · [读完了？12 条工程原则是一张对照清单 →](../../principles/README.md)
