...
- [04 Embedding 与向量检索基础](../04-embeddings-and-vector-search/README.md)：隔了九课，三条结论这一课直接要用——归一化之后余弦就是点积；切块大小决定召回粒度，改切块等于改召回；换 embedding 模型必须重建全部向量。忘了先回去翻一遍那一课的「怎么理解它」
...
[← 上一课 13](../13-agent-harness/README.md) · [下一课 15 →](../15-memory/README.md)
