...
<li markdown="span">**先花十分钟**，读[课程总览](lessons/README.md)，知道六个 Part 各在搭什么。不确定底子够不够，对一下[补充基础](prerequisites/README.md)。</li>
...
固定九节：**为什么需要** → **心智模型** → **机制拆解** → **常见错误** → **取舍** → **工程落地** → **框架映射** → **一线经验** → **参考实现**。每课 1～2.5 小时。
