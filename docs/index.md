...
<p class="path__pick" markdown="span">推荐章节：[00 起步](lessons/00-setup/README.md) → Part 1 到 Part 5 顺着读 → [12 条工程原则](principles/README.md)</p>
<p class="path__go" markdown="span">[开始读 00 起步](lessons/00-setup/README.md){ .md-button .md-button--primary }</p>
...
<li markdown="span">**从 [00 起步](lessons/00-setup/README.md)顺着读。** 编号是推荐顺序，前一课多半是后一课的地基，顺着读最省力。</li>
...
<p class="path__pick" markdown="span">推荐章节：[17 系统架构](lessons/17-system-architecture/README.md) → [19 可观测性](lessons/19-observability/README.md) · [18 评测](lessons/18-evaluation/README.md) → [20 可靠性与成本](lessons/20-reliability-cost-llmops/README.md) · [21 安全与治理](lessons/21-security-governance/README.md)</p>
<p class="path__go" markdown="span">[从 17 系统架构开始](lessons/17-system-architecture/README.md){ .md-button .md-button--primary }</p>
<details class="path__more" markdown="1">
<summary>这条路线怎么读</summary>
<ol class="tl" markdown="1">
